...
public class LogisticsApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/cn/xzlei/luxurycarjavafx/inventory/contentInventoryView.fxml"));
        ...
        stage.setTitle("豪车管理系统v1.0 - 库存信息查看[当前权限：logistics]");
